...
{
    #[OA\Get(
        path: '/api/admin/v1/projects/{project}/content/localizations',
        operationId: 'content_index_api_admin_v1_projects_project_content_localizations',
        tags: ['content'],
        summary: 'GET /api/admin/v1/projects/{project}/content/localizations',
        security: [['bearerAuth' => []]],
        parameters: [
            new OA\Parameter(name: 'project', in: 'path', required: true, schema: new OA\Schema(type: 'string')),
            new OA\Parameter(name: 'service', in: 'query', required: false, schema: new OA\Schema(type: 'string', maxLength: 32)),
            new OA\Parameter(name: 'locale', in: 'query', required: false, schema: new OA\Schema(type: 'string', maxLength: 12)),
        ],
