...
final class SystemInstructCatalog
{
    ...
    public static function all(): array
    {
        return [
            ...
            [
                'category' => InstructCategory::CitySeo,
                'title' => 'SEO-поля города',
                'rule' => 'Заполни SEO-поля страницы города под тематику проекта: заголовок до 60 символов, описание до 160 символов, ключевые слова через запятую и поля для соцсетей — заголовок и описание Open Graph, тип карточки Twitter (summary или summary_large_image). Название города склоняй по-русски и упоминай его в заголовке и описании. Пиши про тематику проекта в этом городе, не выдумывай адресов, цен и телефонов.',
                'schema' => self::seoProperties(),
            ],
            [
