...
{
    #[OA\Post(path: '/internal/cache-bust', operationId: 'shared_cache_bust_internal_cache_bust', tags: ['auth'], summary: 'POST /internal/cache-bust', responses: [new OA\Response(response: 200, description: 'OK'), new OA\Response(response: 401, description: 'Unauthenticated')])]
