...
final class SeoFilesController
{
    ...
    #[OA\Get(path: '/sitemap.xml', operationId: 'content_sitemap_sitemap_xml', tags: ['content'], summary: 'GET /sitemap.xml', security: [['apiKey' => []]], responses: [new OA\Response(response: 200, description: 'OK'), new OA\Response(response: 401, description: 'Unauthenticated'), new OA\Response(response: 422, description: 'Validation error')])]
    ...
    #[OA\Get(path: '/robots.txt', operationId: 'content_robots_robots_txt', tags: ['content'], summary: 'GET /robots.txt', security: [['apiKey' => []]], responses: [new OA\Response(response: 200, description: 'OK'), new OA\Response(response: 401, description: 'Unauthenticated'), new OA\Response(response: 422, description: 'Validation error')])]
