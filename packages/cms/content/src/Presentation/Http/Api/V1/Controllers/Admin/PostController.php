    ...
    #[OA\Post(
        ...
        requestBody: new OA\RequestBody(required: true, content: new OA\JsonContent(
            ...
            properties: [
                ...
                new OA\Property(property: 'body', type: 'string', nullable: true, description: 'Только чтение: собирается из blocks, переданное значение не применяется'),
                ...
                new OA\Property(property: 'blocks', type: 'array', items: new OA\Items(
                    required: ['markdown'],
                    properties: [
                        new OA\Property(property: 'id', type: 'string', maxLength: 64, nullable: true),
                        new OA\Property(property: 'title', type: 'string', maxLength: 255, nullable: true),
                        new OA\Property(property: 'markdown', type: 'string'),
                    ],
                    type: 'object',
                )),
            ],
