...
final class SettingsController
{
    ...
    #[OA\Put(path: '/api/admin/v1/projects/{project}/pay/settings', operationId: 'pay_update_api_admin_v1_projects_project_pay_settings', tags: ['pay'], summary: 'PUT /api/admin/v1/projects/{project}/pay/settings', responses: [new OA\Response(response: 200, description: 'OK'), new OA\Response(response: 401, description: 'Unauthenticated'), new OA\Response(response: 422, description: 'Validation error')])]
