...
import { PanelLeftClose, PanelLeftOpen, Settings, LifeBuoy, LogOut } from "lucide-react";
...
export function AdminTopbar() {
  ...
  const [storefrontUrl, setStorefrontUrl] = useState<string>(siteConfig.urls.storefrontDefault);
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      return () => window.removeEventListener("storefront-url-updated", handleUpdate);
    }
  }, []);
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        <DropdownMenu open={open} onOpenChange={setOpen}>
          <DropdownMenuTrigger asChild>
            <Button variant="outlined" shape="circle" size="auto" className="py-2 pl-4 pr-2">
