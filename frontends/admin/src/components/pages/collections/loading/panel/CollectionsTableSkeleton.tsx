...
/**
 * Mirrors CollectionsPanel DataGrid (default viewMode is table, 8 per page):
 * checkbox, collection, products, revenue, views, growth, featured, actions.
 */
      ...
      <ul className="flex flex-col">
        {Array.from({ length: ROW_COUNT }, (_, index) => (
          ...
          >
            ...
            <Skeleton className="hidden h-6 w-16 shrink-0 rounded-full xl:block" />
